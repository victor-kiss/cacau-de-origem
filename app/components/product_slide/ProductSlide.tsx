...
export default function ProductSlide({...props}:HtmlHTMLAttributes<HTMLElement>) {
  ...
  return (
    <section className="bg-cacao text-cacao-dark relative w-full min-h-screen flex flex-col-reverse lg:flex-row sm:gap-8 overflow-hidden" {...props}>
      <ChocolateWave
